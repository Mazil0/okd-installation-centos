...
export OKD_MASTER_IP=192.168.20.37
export OKD_MASTER_HOSTNAME=inf-d-ocm01

#OKD Worker Node 1 Configuration
export OKD_WORKER_NODE_1_IP=192.168.20.38
export OKD_WORKER_NODE_1_HOSTNAME=inf-d-ocw01

#OKD Worker Node 2 Configuration
export OKD_WORKER_NODE_2_IP=192.168.20.39
export OKD_WORKER_NODE_2_HOSTNAME=inf-d-ocw02
...
export OKD_INFRA_NODE_1_IP=192.168.20.36
export OKD_INFRA_NODE_1_HOSTNAME=inf-d-oci01
